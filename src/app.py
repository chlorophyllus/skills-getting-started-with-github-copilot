...
activities = {
    ...
    "Soccer Club": {
        "description": "Learn soccer skills and play in tournaments",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "benjamin@mergington.edu"]
    },
    "Art Club": {
        "description": "Create and showcase artistic works",
        "schedule": "Fridays, 2:00 PM - 4:00 PM",
        "max_participants": 12,
        "participants": ["aviva@mergington.edu", "maya@mergington.edu"]
    },
    "Drama Club": {
